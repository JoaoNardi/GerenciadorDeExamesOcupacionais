...
public class CondicaoDAO {
    ...
    private static final String CADASTRAR_LISTA_CONDICAO = "INSERT INTO condicoes (id, tipo_exame_id, referencia, operador, parametro, " +
            "periodicidade) " +
            "VALUES (null, ?, ?, ?, ?, ?)";
    ...
    public void cadastrarListaCondicao(ObservableList<Condicao> lista) {
        Connection connection = DBConexao.getInstance().abrirConexao();
        try {
            preparedStatement = connection.prepareStatement(CADASTRAR_LISTA_CONDICAO);
